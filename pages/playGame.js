            ...
            <div className="row">
              <div className="col-4 text-center">
                ...
                <div className="">
                  <img
                    ...
                    alt=""
                    id="gunting"
                    className={classes.gunting}
                  />
                </div>
              </div>
              <div className="col-4 text-center">
                <div id="vs" className={classes.vs}>
                  VS
                </div>
              ...
              <div className="col-4 text-center">
                ...
                <img
                  ...
                  alt=""
                  id="komputerPilihan"
                  className={classes.komputerPilihan}
                />
              </div>
            </div>
          </div>
          <Script src="/js/guntingBatu.js" strategy="afterInteractive" />
        </div>
      </section>
    </div>
  );
